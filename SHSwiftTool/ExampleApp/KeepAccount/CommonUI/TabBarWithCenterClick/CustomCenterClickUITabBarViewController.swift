//
//  CustomCenterClickUITabBarViewController.swift
//  SHSwiftTool
//
...
class CustomCenterClickUITabBarViewController: UITabBarController, CustomCenterClickUITabBarDelegate {
    ...
    public func setTabBar(tabBar: UITabBar) {
        ...
        let tab = CustomCenterClickUITabBar()
        tab.customCenterClickUITabBarDelegate = self
