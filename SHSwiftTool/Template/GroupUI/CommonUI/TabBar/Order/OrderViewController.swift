...
class OrderViewController: UIViewController, NavigationBarViewHolderDelegate {

    private static let TAG = "OrderViewController"
    ...
    private func initNavigationBar() {
        ...
        if(navigationBarViewHolder == nil) {
            ...
            navigationBarViewHolder!.setTitle(title: OrderViewController.TITLE)
    ...
    func onButtonLeftClicked() {
        ILog.debug(tag: OrderViewController.TAG, content: "onButtonLeftClicked")
    }
    
    func onButtonRightClicked() {
        ILog.debug(tag: OrderViewController.TAG, content: "onButtonRightClicked")
    }
