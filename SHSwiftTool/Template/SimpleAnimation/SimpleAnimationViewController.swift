...
class SimpleAnimationViewController: UIViewController {
    ...
    private static let TAG = "SimpleAnimationViewController"
    
    private var fullSize = UIScreen.main.bounds.size
    ...
    func createButtonsAndLabel() {
        ...
        btn.addTarget(nil, action: #selector(AnimateBounds), for: .touchUpInside)
        ...
        btn.setTitleColor(UIColor.blue, for: .normal)
        btn.addTarget(nil, action: #selector(AnimateAlpha), for: .touchUpInside)
        ...
        btn.setTitleColor(UIColor.blue, for: .normal)
        btn.addTarget(nil, action: #selector(AnimateBackgroundColor), for: .touchUpInside)
        ...
        btn.setTitleColor(UIColor.blue, for: .normal)
        btn.addTarget(nil, action: #selector(AnimateCenter), for: .touchUpInside)
        ...
        btn.setTitleColor(UIColor.blue, for: .normal)
        btn.addTarget(nil, action: #selector(AnimateTransform), for: .touchUpInside)
        ...
        btn.setTitleColor(UIColor.blue, for: .normal)
        btn.addTarget(nil, action: #selector(AnimateAll), for: .touchUpInside)
